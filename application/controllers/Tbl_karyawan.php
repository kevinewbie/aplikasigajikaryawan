...
class Tbl_karyawan extends CI_Controller
{
    ...
    {
        $this->template->load('template','tbl_karyawan/tbl_karyawan_list');
    } 
    ...
    public function read($id) 
    {
		...
		'divisi_karyawan' => $row->divisi_karyawan,
            ...
            $this->template->load('template','tbl_karyawan/tbl_karyawan_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','tbl_karyawan/tbl_karyawan_form', $data);
    }
