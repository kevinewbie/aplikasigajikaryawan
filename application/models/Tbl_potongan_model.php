...
class Tbl_potongan_model extends CI_Model
{

    public $table = 'tbl_potongan';
...
/* End of file Tbl_potongan_model.php */
/* Location: ./application/models/Tbl_potongan_model.php */
