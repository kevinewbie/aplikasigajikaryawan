...
class Tbl_tunjangan extends CI_Controller
{
    ...
    {
        $this->template->load('template','tbl_tunjangan/tbl_tunjangan_list');
    } 
    ...
    public function read($id) 
    {
		...
		'tunjangan_transport' => $row->tunjangan_transport,
            ...
            $this->template->load('template','tbl_tunjangan/tbl_tunjangan_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('tbl_tunjangan'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('tbl_tunjangan/create_action'),
        ...
        $this->template->load('template','tbl_tunjangan/tbl_tunjangan_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('tbl_tunjangan/update_action'),
...
/* End of file Tbl_tunjangan.php */
/* Location: ./application/controllers/Tbl_tunjangan.php */
